...
class VpcStack extends Stack {
    constructor(scope, id, props) {
        ...
        albSG.addIngressRule(ec2.Peer.anyIpv4(), ec2.Port.tcp(5002), 'Allow ExpressJS on port 5002');
        albSG.addIngressRule(ec2.Peer.ipv4(names.HOME_IP_CIDR), ec2.Port.tcp(22));
        ...
        const testLambda = new lambda.Function(this, names.TEST_LAMBDA_NAME, {
            ...
            layers: [
                lambda.LayerVersion.fromLayerVersionArn(this, 'DependenciesLayer', 'arn:aws:lambda:us-east-1:511873596089:layer:vectopus-dependencies:3'),
                lambda.LayerVersion.fromLayerVersionArn(this, 'VectopusLibsLayer', 'arn:aws:lambda:us-east-1:511873596089:layer:vectopus-libs:63'),
            ],
        });
